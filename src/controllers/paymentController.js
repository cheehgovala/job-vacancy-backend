...
const BACKEND_URL = process.env.BACKEND_URL || "https://job-vacancy-backend.onrender.com";
const FRONTEND_URL = process.env.FRONTEND_URL || "https://smart-hire-malawi-app.vercel.app";
